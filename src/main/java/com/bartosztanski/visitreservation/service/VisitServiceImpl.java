...
public class VisitServiceImpl implements VisitService{
	...
	@Override
	public Visit book(VisitBookingRequest request) throws VisitNotAvailableException, NoSuchElementException {
	...
	public List<Visit> getByEmployee(String employeeId) throws NoSuchElementException {
		...
		EmployeeEntity employeeEntity = ObjectMapperUtils.map(employeeService.getById(employeeId),EmployeeEntity.class);
